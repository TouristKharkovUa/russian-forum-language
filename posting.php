...
$lang = array_merge($lang, array(
	...
	'POLL_VOTE_NAME'			=> 'Открытый опрос?',
	'POLL_VOTE_NAME_EXPLAIN'	=> 'Если включено, то пользователи смогут выбрать как им отвечать: открыто (ник будет отображаться в результатах) или закрыто (ник не будет отображаться в результатах).',	
	...
	'BBCODE_H_HELP'				=> 'Вставить скрытый текст: [spoiler]Текст[/spoiler]',
//BB3AddFields
...
//--BB3AddFields	
	...
	'TAGS_CHECKING_ALERT'		=> 'Пожалуйста, укажите хотя бы один фильтр для темы!',
));
