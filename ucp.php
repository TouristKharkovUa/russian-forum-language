...
$lang = array_merge($lang, array(
	...
	'ADBLOCK'						=> 'Отключить рекламу на форуме',
	'ADBLOCK_EXPLAIN'				=> '<i>У Вас нет прав на отключение рекламы на форуме. Для добавления права "Отключить рекламу" Вам необходимо приобрести одноименную дополнительную услугу</i>',
	'ADD'							=> 'Добавить',
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Если вы хотите изменить имя пользователя или адрес email, вы должны указать текущий пароль. Кроме случая первичного ввода e-mail и пароля после регистрации через сеть "В Контакте"',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Если вы хотите изменить пароль, адрес email или имя пользователя, вы должны указать текущий пароль. Кроме случая первичного ввода e-mail и пароля после регистрации через сеть "В Контакте"',
	...
	'NOTIFY_FRIENDS'				=> 'Уведомлять меня о новых темах моих друзей',
	...
	'OUT_PAGE_TITLE_1'			=> '<strong>Вход или регистрация через соцсети</strong>',
	'OUT_PAGE_TITLE_2'			=> '<strong>Обычная стандартная регистрация</strong>',
	'OUT_PAGE_TITLE_3'			=> '<b style="color: #000080;">После регистрации через социальные сети необходимо посетить свой личный раздел и заполнить необходимые данные о себе (в том числе e-mail и новый пароль для форума).</b>',
	...
	'CHAT_PM'					=> 'Отображать личные сообщения в виде чата',
	...
	'OUT_REGISTER_ERROR'			=> 'Сервер социальной сети вернул ошибку: <strong>«%1$s»</strong><br />Попробуйте авторизоваться заново или обратитесь к администратору',
	'OUT_REGISTER_NOT_PROVIDER'		=> 'Не выбрана социальная сеть для входа',
	'OUT_REGISTER_PROVIDER_DISABLE'	=> 'Регистрация через выбранную социальную сеть отключена.',
	'OUT_REGISTER_UNKNOWN_USER_ID'	=> 'ID пользователя не определено. Попробуйте авторизоваться заново или обратитесь к администратору',
	'OUT_REGISTER_USERNAME_TAKEN'	=> 'Извините, пользователь с таким именем уже существует',
	'OUT_REGISTER_USERNAME_TAKEN_CONFIRM'	=> 'Если это Вы регистрировались ранее через другую социальную сеть, то залогиньтесь через эту соцсеть и укажите в Личном разделе идентификаторы Ваших профилей других соцсетей.<br /><b>Вы хотите продолжить регистрацию нового акаунта на форуме?</b>',

	'VK_UID_USED'				=> 'Указанный аккаунт уже используется другим пользователем. Если это действительно Ваш аккаунт сети "В Контакте" - обратитесь к Администратору!!!',
	'FB_UID_USED'				=> 'Указанный аккаунт уже используется другим пользователем. Если это действительно Ваш аккаунт сети "Facebook" - обратитесь к Администратору!!!',
	'OUT_LOGIN_REDIRECT'			=> '<br /><strong>Вы будете перенаправлены в Личный раздел где необходимо заполнить обязательные поля профиля, указать свой e-mail и изменить пароль</strong>',
