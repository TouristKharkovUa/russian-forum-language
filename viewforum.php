...
$lang = array_merge($lang, array(
	...
	'FILTER'				=> 'Фильтр тем в разделе',
	'FILTER_BUTTON'			=> 'Отфильтровать темы',
	'EVALUATE_TOPIC'		=> 'Рейтинг изделия',
	'TAGS_EDIT'				=> 'Редактирование тегов',
	'TAGS'					=> 'Установка фильтров на тему - обязательна! Следите за актуальностью фильтров по мере продажи!',
	'TAGS_SET_SUCCESS'		=> 'Теги обновлены успешно',
	'TOPIC_ID_EMPTY'		=> 'Тема не указана',
	'MODE_EMPTY'			=> 'Неизвестный режим параметров',
	'NO_AUTH'				=> 'Вы не имеете прав на выполнение данной операции',
));
