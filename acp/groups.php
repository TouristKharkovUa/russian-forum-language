...
$lang = array_merge($lang, array(
	...
	'GROUP_BUMP_INTERVAL'			=> 'Задержка поднятия темы',
	'GROUP_BUMP_INTERVAL_EXPLAIN'	=> 'Количество часов с последнего сообщения, по прошествии которых можно поднимать тему. Введите 0 для использования общего значения',
	'GROUP_DAYLY_BUMP_LIMIT'		=> 'Дневной лимит поднятия тем',
	'GROUP_DAYLY_BUMP_LIMIT_EXPLAIN'=> 'Предельное количество поднятий тем одним пользователем за сутки. Введите 0 для использования стандартных ограничений для ггруппы Зарегистрированные пользователи',
