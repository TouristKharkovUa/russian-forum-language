...
// Added with Quick reply for phpBB3 MOD
	...
	'LOG_CONFIG_QUICK_REPLY'	=> '<strong>Изм. настройки быстрого ответа</strong>',
...
$lang = array_merge($lang, array(
	...
	'LOG_USER_UPDATE_VK_UID'=> '<strong>Пользователем "%1$s" изменён Номер страницы сети "В Контакте"</strong><br />» с «%2$s» на «%3$s»"',
