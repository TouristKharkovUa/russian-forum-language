...
$lang = array_merge($lang, array(
	...
	'acl_u_adblock'		=> array('lang' => 'Может блокировать отображение рекламы', 'cat' => 'misc'),
));
...
$lang = array_merge($lang, array(
	...
	'acl_f_delete_bin'	=> array('lang' => 'Может удалять свои темы в Корзину', 'cat' => 'actions'),
));
...
$lang = array_merge($lang, array(
	...
	'acl_m_ban'		=> array('lang' => 'Может управлять блокировкой<br /><em>Это право может быть назначено только глобально, а не на уровне форумов.</em>', 'cat' => 'misc'), // This moderator setting is only global (and not local)
		// -----------------------------------------
	// Stephen, 27.12.2007
	// Berechtigung Admin Coppermine ergдnzt
	// -----------------------------------------
	'acl_m_cpgadmin'		=> array('lang' => 'Может управлять coppermine галереей<br /><em>Это право может быть назначено только глобально, а не на уровне форумов.</em>', 'cat' => 'misc'),
	// -----------------------------------------
...
$lang = array_merge($lang, array(
	...
	// Berechtigung Admin Coppermine ergдnzt
	// -----------------------------------------
	'acl_a_cpgadmin'		=> array('lang' => 'Может управлять coppermine галереей', 'cat' => 'misc'),
	// -----------------------------------------
));
