...
$lang = array_merge($lang, array(
    ...
    'IMG_ICON_EVALUATION_HALF'  => 'Оценка средняя',
    'IMG_ICON_EVALUATION_DARK'  => 'Оценка низкая',
    'IMG_ICON_EVALUATION_LIGHT' => 'Оценка высокая',
));
//-- mod : Genders ------------------------------------------------------------
//-- add
$lang = array_merge($lang, array(
	'IMG_ICON_GENDER_X'	=> 'Пол: не указан',
	'IMG_ICON_GENDER_M'	=> 'Пол: Муж',
	'IMG_ICON_GENDER_F'	=> 'Пол: Жен',
));
//-- fin mod : Genders --------------------------------------------------------
