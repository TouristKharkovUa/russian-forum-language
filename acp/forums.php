...
$lang = array_merge($lang, array(
	'ADD_FROM_SUBFORUMS'		=> 'Выводить темы из подфорумов',
	'ADD_FROM_SUBFORUMS_EXPLAIN'=> 'При включении этой опции темы из подфорумов будут показаны вместе с темами родительского форума.',
	'NO_COMMERCE'				=> 'Выбор "Без коммерческих"',
	'NO_COMMERCE_EXPLAIN'		=> 'При включении этой опции в форуме будет доступна возможность скрытия тем от пользователей из группы "Коммерсы".',
	...
	'FORUM_LOGO_EXPLAIN'				=> 'Путь относительно корневой папки phpBB к дополнительному изображению, которое будет отображаться в логотипе конференции при нахождении пользователя в данном форуме.',
	'FORUM_IMAGE_NO_EXIST'				=> 'Указанный значок форума не существует',
	'FORUM_LOGO_NO_EXIST'				=> 'Указанный логотип форума не существует',
	...
	'OVERRIDE_USER_SORT_ORDER'		=> 'Заменять порядок сортировки',
	'OVERRIDE_USER_SORT_ORDER_EXPLAIN' => 'Порядок сортировки, выбранный пользователем, будет заменен на порядок по умолчанию.',
	...
	'TOPIC_LIST_ORDER'			=> 'Порядок вывода тем',
	'TOPIC_LIST_ORDER_EXPLAIN'	=> 'Выберите порядок сортировки тем. По умолчанию используется сортировка по последнему сообщению. Пользователи могут для себя переопределить эту настройку в личном разделе.',
	'TYPE_CAT'			=> 'Категория',
	'TYPE_FORUM'		=> 'Форум',
	'TYPE_LINK'			=> 'Ссылка',
