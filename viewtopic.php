...
$lang = array_merge($lang, array(
	...
	'SHOW_VOTER_NAME'		=> 'Показывать Ваш ник в результатах?',
	...
	'ADD_FOE'				=> 'Добавить в игнор',
	'ADD_FRIEND'			=> 'Добавить в друзья',
	'REMOVE_FOE'			=> 'Убрать из игнора',
	'REMOVE_FRIEND'			=> 'Убрать из друзей',
	'NEXT_BUMP_TOPIC_MSG'	=> 'Up возможен через: %s',
	'CUR_DAYLY_BUMP_LIMIT'	=> 'Вы исчерпали дневной лимит из %d бесплатных up-ов',
));
